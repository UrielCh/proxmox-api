...
export namespace Proxmox {
    ...
    export interface nodesLxcConfigVmConfig {
         ...
         * additionalProperties
         */
        [net_x: `net${number}`]: string | undefined;
        [additionalProperties: string]: any;
    }
    /**
